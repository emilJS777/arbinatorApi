...
from src.OrderBookRecovery.OrderBookRecoveryController import OrderBookRecoveryConfigController, OrderBookRecoveryConfigRawController, OrderBookRecoveryOptionsController, OrderBookRecoveryStartController, OrderBookRecoveryStopController, OrderBookRecoveryStateController, OrderBookRecoveryTradeController, OrderBookRecoveryMetricsController, OrderBookRecoveryDebugController, OrderBookRecoveryDiagnosticsClearController, OrderBookRecoveryRecoveryResetController, OrderBookRecoverySetCurrentMarginController, OrderBookRecoveryForwardTestController, OrderBookRecoveryForwardTestItemController, OrderBookRecoveryForwardTestMetricsController, OrderBookRecoveryManualCloseController, OrderBookRecoveryTradeArchiveController, OrderBookRecoveryTradeDeleteArchivedController, OrderBookRecoveryDeleteAllArchivedController, OrderBookRecoveryArchiveAllClosedController, OrderBookRecoveryUnarchiveAllController, OrderBookRecoveryTradeDecisionDetailsController, OrderBookRecoveryTradeExportController, OrderBookRecoveryMLDatasetExportController, OrderBookRecoveryMLDatasetClearController, OrderBookRecoveryMLFeatureSnapshotExportController, OrderBookRecoveryMLStatsController, OrderBookRecoveryMLMarketSnapshotExportController, OrderBookRecoveryMLExchangeLabelsExportController, OrderBookRecoveryMLPriceHistoryExportController, OrderBookRecoveryMLFeatureSnapshotListController, OrderBookRecoveryMLFeatureSnapshotDetailController, OrderBookRecoveryMLMarketSnapshotListController, OrderBookRecoveryMLMarketSnapshotDetailController, OrderBookRecoveryMLPriceHistoryListController, OrderBookRecoveryMLPriceHistoryDetailController, OrderBookRecoveryMLExchangeLabelListController, OrderBookRecoveryMLExchangeLabelDetailController
...
api.add_resource(OrderBookRecoveryDiagnosticsClearController, "/api/orderbook-recovery/diagnostics/clear")
api.add_resource(OrderBookRecoveryRecoveryResetController, "/api/orderbook-recovery/recovery/reset")
api.add_resource(OrderBookRecoverySetCurrentMarginController, "/api/orderbook-recovery/recovery/set-current-margin")
...
api.add_resource(OrderBookRecoveryMLStatsController, "/api/orderbook-recovery/ml/stats")
api.add_resource(OrderBookRecoveryMLDatasetClearController, "/api/orderbook-recovery/ml/dataset/clear")
api.add_resource(OrderBookRecoveryMLDatasetExportController, "/api/orderbook-recovery/ml/dataset/export")
api.add_resource(OrderBookRecoveryMLMarketSnapshotExportController, "/api/orderbook-recovery/ml/market-snapshots/export")
api.add_resource(OrderBookRecoveryMLExchangeLabelsExportController, "/api/orderbook-recovery/ml/exchange-labels/export")
api.add_resource(OrderBookRecoveryMLFeatureSnapshotExportController, "/api/orderbook-recovery/ml/feature-snapshots/export")
api.add_resource(OrderBookRecoveryMLPriceHistoryExportController, "/api/orderbook-recovery/ml/price-history/export")
api.add_resource(OrderBookRecoveryMLFeatureSnapshotListController, "/api/orderbook-recovery/ml/feature-snapshots")
api.add_resource(OrderBookRecoveryMLFeatureSnapshotDetailController, "/api/orderbook-recovery/ml/feature-snapshots/<int:item_id>")
api.add_resource(OrderBookRecoveryMLMarketSnapshotListController, "/api/orderbook-recovery/ml/market-snapshots")
api.add_resource(OrderBookRecoveryMLMarketSnapshotDetailController, "/api/orderbook-recovery/ml/market-snapshots/<int:item_id>")
api.add_resource(OrderBookRecoveryMLPriceHistoryListController, "/api/orderbook-recovery/ml/price-history")
api.add_resource(OrderBookRecoveryMLPriceHistoryDetailController, "/api/orderbook-recovery/ml/price-history/<int:item_id>")
api.add_resource(OrderBookRecoveryMLExchangeLabelListController, "/api/orderbook-recovery/ml/exchange-labels")
api.add_resource(OrderBookRecoveryMLExchangeLabelDetailController, "/api/orderbook-recovery/ml/exchange-labels/<int:item_id>")
